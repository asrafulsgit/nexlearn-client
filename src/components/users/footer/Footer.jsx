...
const Footer = () => {
  return (
    <footer className="mx-auto bg-green-600 ">
      <div className="max-w-7xl mx-auto text-gray-100 pt-12 pb-6 px-4 md:px-12 lg:px-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          {/* Brand Info */}
          <div>
            <h2 className="text-2xl font-bold text-white mb-3">NexLearn</h2>
            <p className="text-justify leading-relaxed">
              NexLearn connects students and tutors in a collaborative
              environment to enhance learning through structured sessions and
              shared resources.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              >
                <svg
                  className="w-7 h-7 fill-current text-gray-200 hover:text-white"
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  className="w-9 h-7 fill-current text-gray-200 hover:text-white"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="border-t border-green-500 pt-6 text-center text-sm text-green-100">
          © 2025 NexLearn. All rights reserved. &nbsp; | &nbsp; Made with 💚 by
          Asraful
        </div>
      </div>
    </footer>
