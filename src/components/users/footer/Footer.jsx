...
import { Link } from "react-router";
 ...
 const  Footer =()=> {
  return (
     <footer className="max-w-7xl mx-auto bg-green-600 text-gray-100 pt-12 pb-6 px-4 md:px-12 lg:px-24">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link  to='/study-sessions'  className="hover:text-white transition">Study Sessions</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="/privacy-policy" className="hover:text-white transition">Privacy Policy
            </Link></li>
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-4">
            <a href="https://facebook.com" target="_blank" className="hover:text-white transition" aria-label="Facebook">
              <svg className="w-7 h-7 fill-current text-gray-200 hover:text-white" viewBox="0 0 24 24">
            ...
            <a href="https://x.com" target="_blank" className="hover:text-white transition" aria-label="Twitter">
              <svg className="w-7 h-7 fill-current text-gray-200 hover:text-white" viewBox="0 0 24 24">
            ...
            <a href="https://youtube.com" target="_blank" className="hover:text-white transition" aria-label="YouTube">
              <svg className="w-9 h-7 fill-current text-gray-200 hover:text-white" viewBox="0 0 24 24">
          ...
          {/* <p className="">📧 support@nexlearn.com</p> */}
        </div>
      </div>
